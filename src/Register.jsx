              ...
              <div className="space-y-3" ref={oauthContainerRef}>
                ...
                <div className="relative w-full" style={{ height: '48px' }}>
                  ...
                  <button
                    ...
                    disabled={isGoogleLoading || isGithubLoading || isSending || isVerifying}
                    style={{
                      backgroundColor: '#FFFFFF',
                      borderColor: '#E6FAF5',
                      color: '#2C3E50',
                      opacity: (isGoogleLoading || isGithubLoading || isSending || isVerifying) ? 0.7 : 1,
                      cursor: (isGoogleLoading || isGithubLoading || isSending || isVerifying) ? 'not-allowed' : 'pointer'
                    }}
                  >
                    {isGoogleLoading ? (
                      <>
                  ...
                  {!isGoogleLoading && !isGithubLoading && !isSending && !isVerifying && (
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-3 py-3 px-4 border-2 rounded-lg font-semibold transition-all duration-200 ${
                    isGoogleLoading || isGithubLoading || isSending || isVerifying ? 'opacity-70 cursor-not-allowed' : 'hover:shadow-soft'
                  }`}
                  style={{
                    backgroundColor: '#FFFFFF',
                    borderColor: '#E6FAF5',
                  ...
                  onMouseEnter={(e) => {
                    if (!isGoogleLoading && !isGithubLoading && !isSending && !isVerifying) {
