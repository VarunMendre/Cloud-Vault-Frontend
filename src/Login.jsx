        ...
        <div className="bg-white rounded-2xl shadow-strong p-8">
          ...
          <div className="space-y-3" ref={oauthContainerRef}>
            ...
            <div className="relative w-full" style={{ height: '48px' }}>
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 py-3 px-4 border-2 rounded-lg font-semibold transition-all duration-200 hover:shadow-soft absolute inset-0 z-0"
                style={{
                  backgroundColor: '#FFFFFF',
                  borderColor: '#E6FAF5',
                  color: '#2C3E50'
              ...
              {/* Invisible Google Login on top to capture clicks */}
